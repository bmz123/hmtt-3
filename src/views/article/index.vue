  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-form label-width="80px" size="small">
        ...
        <!-- 自己的下拉框组件 -->
        <!-- <my-channel :value="filterParams.channel_id" @input="filterParams.channel_id=$event"> -->
   <my-channel v-model="filterParams.channel_id">
        </my-channel>
        </el-form-item>
    ...
    <el-card>
      ...
      <el-table :data="articles">
        ...
        <el-table-column label="状态">
          <template slot-scope="scope">
            <el-tag v-if="scope.row.status===0" type="info">草稿状态</el-tag>
